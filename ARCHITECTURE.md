...
This project provides a single Docker container that hosts both **[RWAV Bridge](https://rwav-bridge.co.uk/)** (Roon extension) and **[RWAV Bridge MCP](https://rwav-bridge.co.uk/)** server, enabling AI-powered control of Roon from MCP clients.
